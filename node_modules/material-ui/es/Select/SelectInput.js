...
class SelectInput extends React.Component {
  constructor(...args) {
    ...
    return _temp = super(...args), this.state = {
      open: false
    }, this.ignoreNextBlur = false, this.displayNode = null, this.displayWidth = null, this.isControlled = this.props.open !== undefined, this.update = this.isControlled ? ({ event, open }) => {
      if (open) {
